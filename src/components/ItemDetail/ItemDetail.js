...
const ItemDetail = ({ item, show, onClose }) => {
  ...
  return (
    <div
      ...
      id={item[variantNmbr]["internal-id"]}
      onClick={onClose}
    >
      <div
        className="item-detail-modal-content"
        onClick={(e) => e.stopPropagation()}
      >
        <span className="item-detail-modal-close" onClick={onClose}>
          &times;
        </span>
        ...
        <div className="item-detail-info">Details will go here</div>
      </div>
    </div>
  );
};
